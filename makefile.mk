...
SRC = src
INCLUDES = includes
OBJS = $(OUTDIR)/indexer.o $(OUTDIR)/sentence_tokenizer_strategy.o $(OUTDIR)/word_tokenizer_strategy.o $(OUTDIR)/tokenizer.o $(OUTDIR)/document.o $(OUTDIR)/sentence.o $(OUTDIR)/stopword.o $(OUTDIR)/util.o $(OUTDIR)/index_item.o $(OUTDIR)/term_index.o $(OUTDIR)/query_result.o $(OUTDIR)/document_indexer.o $(OUTDIR)/sentence_indexer.o $(OUTDIR)/movie_indexer.o $(OUTDIR)/movie.o $(OUTDIR)/index_exception.o
CC = g++
DEBUG = -O
CFLAGS = -c $(DEBUG)
FLAGS = -std=c++11
...
$(OUTDIR)/recommender.o : $(SRC)/recommender.cpp $(INCLUDES)/recommender.h
